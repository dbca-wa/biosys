    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('project', 'Project'), ('site', 'Site'), ('generic', 'Generic'), ('observation', 'Observation'), ('species_observation', 'Species observation')], default='generic', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='data_sets', related_query_name='data_set', to='main.DataSet')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
        ...
        migrations.AddField(
            model_name='site',
            name='dataset',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.DataSet'),
        ),
        migrations.AddField(
            model_name='site',
            name='geology_group',
